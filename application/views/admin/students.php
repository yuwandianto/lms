...
<div class=" modal fade" id="ubahDataSiswa" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form id="formUbahDataSiswa">
                <input type="hidden" id="idUbahSiswa" name="idUbahSiswa" value="">
                <div class="modal-body">
                    <div class="row mb-1">
                        <label for="ubahNamaSiswa" class="col-sm-3 col-form-label">Nama Siswa</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="ubahNamaSiswa" name="ubahNamaSiswa">
                        </div>
                    </div>
                    <div class="row mb-1">
                        <label for="ubahKodeKelas" class="col-sm-3 col-form-label">Kelas</label>
                        <div class="col-sm-9">
                            <select name="ubahKodeKelas" id="ubahKodeKelas" class="form-control">
                                <option value="">-- Pilih Kelas --</option>
                                <?php foreach ($classes as $cls) : ?>
                                    <option value="<?= $cls->kodeKelas; ?>"><?= $cls->namaKelas; ?></option>
                                <?php endforeach; ?>
                    ...
                    <div class="row mb-1">
                        <label for="ubahnisn" class="col-sm-3 col-form-label">NISN</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="ubahnisn" name="ubahnisn">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary tombolSimpanUbahSiswa">Simpan</button>
                </div>
            </form>
        </div>
    </div>
