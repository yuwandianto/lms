                ...
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle <?= ($sub1 == 'class' || $sub1 == 'student' || $sub1 == 'teacher' || $sub1 == 'subject' || $sub1 == 'timing' || $sub1 == 'scedule')  ? 'text-white fw-bold' : ''; ?>" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fas fa-cogs me-2"></i> Pengaturan
                            </a>
                            <ul class="dropdown-menu bg-success noborder <?= ($sub1 == 'class' || $sub1 == 'student' || $sub1 == 'teacher' || $sub1 == 'subject' || $sub1 == 'timing' || $sub1 == 'scedule')  ? 'show' : ''; ?>">
